...
public class GenerateCode {
    ...
    void generateChannelCode(){
        String path = "D:/Java proj/TienChin/tienchin/tienchin-channel/src/main/";
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/fitness?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8", "root", "123456")
    ...
    void generateActivityCode(){
        String path = "D:/Java proj/TienChin/tienchin/tienchin-activity/src/main";
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/fitness?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8", "root", "123456")
                .globalConfig(builder -> {
                    builder.author("javaboy") // 设置作者
                            .outputDir(path + "/java"); // 指定输出目录
    ...
    void generateCourseCode(){
        String path = "D:/Java proj/TienChin/tienchin/tienchin-course/src/main";
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/fitness?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8", "root", "123456")
                .globalConfig(builder -> {
                    builder.author("javaboy") // 设置作者
                            .outputDir(path + "/java"); // 指定输出目录
    ...
    void generateClueCode(){
        String path = "D:/Java proj/TienChin/tienchin/tienchin-clue/src/main";
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/fitness?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8", "root", "123456")
                .globalConfig(builder -> {
                    builder.author("javaboy") // 设置作者
                            .outputDir(path + "/java"); // 指定输出目录
    ...
    void generateBusinessCode(){
        String path = "D:/Java proj/TienChin/tienchin/tienchin-business/src/main";
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/fitness?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8", "root", "123456")
                .globalConfig(builder -> {
                    builder.author("javaboy") // 设置作者
                            .outputDir(path + "/java"); // 指定输出目录
    ...
    void generateContractCode(){
        String path = "D:/Java proj/TienChin/tienchin/tienchin-contract/src/main";
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/fitness?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8", "root", "123456")
                .globalConfig(builder -> {
                    builder.author("javaboy") // 设置作者
                            .outputDir(path + "/java"); // 指定输出目录
